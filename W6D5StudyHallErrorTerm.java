...
public class W6D5StudyHallErrorTerm {
	 ...
	 * @author Sumit
	 * 
	 * @version 0.01	2018-02-16	Initial baseline 
	 * 
	 */
	...
	private static String executeFSM(String input) {
		...
		case 1:
			...
			return "Charachter must be a non zero value.\n"+ 
					displayInput(input, currentCharNdx);

		case 2:
			// This is a stub that must be filled in
			return "Charachter must be in between 0-9.\n"+ 
					displayInput(input, currentCharNdx);

		case 3:
			// This is a stub that must be filled in
			return "There must be some other non zero values.\n"+ 
					displayInput(input, currentCharNdx);

		case 4:
			// This is a stub that must be filled in
			return "Error term with single digit of precision is only allowed.\n"+ 
					displayInput(input, currentCharNdx);
